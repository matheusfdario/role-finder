...
a = Analysis(['gui_run.py'],
             ...
             hiddenimports=['pywt._extensions._cwt', 'scipy.odr', 'surface.surface', 'framework.fk_mig', 'framework.linterp_oper', 'data_types', 'cv2', 'skimage', 'sklearn', 'polarTransform', 'ipykernel.datapub', 'parso'],
