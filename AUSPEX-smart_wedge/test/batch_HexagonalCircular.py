...
from imaging import tfm, tfm3d  # importei tfm3d a mais para uma função que foi usada
...
for i_config in range(2,31,4):
    ...
    # Estava tfm.tfm3d_kernel, alterado para tfm3d.tfm3d_kernel.
    fig = plt.figure()
