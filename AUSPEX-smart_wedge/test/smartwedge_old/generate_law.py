...
if __name__ == "__main__":
    # coord = np.array([-0.01575, -0.01525, -0.01475, -0.01425, -0.01375, -0.01325,
    ...
    v1 = 6.36 # Velocidade do som no espécime em metros por segundo;
    ...
    compensate_time_wedge(90, sm)/1e-6 * 2

    # Define alguns ângulos de onda plana:
    beg_angle = -90
    end_angle = 90
    step = 2
    ...
    # Gera o .law:
    filename = "OndaPlana_-42_42_step" + str(step)
